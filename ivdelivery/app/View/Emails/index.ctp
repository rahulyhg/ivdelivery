<div class="emails index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('driver_email'); ?></th>
			<th><?php echo $this->Paginator->sort('user_email'); ?></th>
			<th><?php echo $this->Paginator->sort('driver_phone'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($email['Email']['driver_email']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['user_email']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['driver_phone']); ?>&nbsp;</td>
		<td><?php echo h($email['Email']['user_phone']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $email['Email']['id']), array(), __('Are you sure you want to delete # %s?', $email['Email']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
